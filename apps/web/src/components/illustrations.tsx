...
export function MoneyStackArt({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="120" cy="36" r="14" fill="oklch(0.88 0.16 95)" stroke="oklch(0.75 0.12 85)" strokeWidth="2" />
      <circle cx="120" cy="36" r="5" fill="oklch(0.35 0.08 85)" />
      <circle cx="42" cy="48" r="10" fill="oklch(0.9 0.2 120)" stroke="oklch(0.75 0.15 120)" strokeWidth="2" />
...
export function ChestArt({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M30 70h120v48c0 8-6 14-14 14H44c-8 0-14-6-14-14V70Z"
      ...
      <rect x="112" y="28" width="28" height="18" rx="3" fill="oklch(0.78 0.15 145)" transform="rotate(12 126 37)" />
      <rect x="40" y="30" width="22" height="14" rx="2" fill="oklch(0.82 0.16 130)" transform="rotate(-18 51 37)" />
    </svg>
  )
}
